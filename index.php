      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <p>
            ...
            costs and long wait times, our founders came together to create a platform that cuts through red tape and brings care directly to those who need it most.
          </p>
        </div>
        <div class="col-md-6">
          <ul class="list-group">
