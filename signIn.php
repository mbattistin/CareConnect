...
<body>
  ...
  <main class="container my-2">
    <div class="card mx-auto" style="max-width: 500px;">
      ...
      <form class="card-body" id="loginForm" name="loginForm" method="POST"
        action="databaseConnection.php?action=userLogin" onsubmit="return validateForm(event)" autocomplete="off">
        ...
        <div class="row">
          <div class="col-6">
            <button type="submit" class="btn btn-dark w-100"><i class="fa fa-sign-in mr-2" aria-hidden="true"></i>Sign
              In</button>
          </div>
          <div class="col-6">
