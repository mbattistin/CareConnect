...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <!-- Collapsed navbar for  responsiveness-->
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="index.php">Home</a>
        </li>
        <!-- validation to display the menu only if the user is logged in -->
        <?php if (isset($_SESSION['role']) && ($_SESSION['role'] === 'user' || $_SESSION['role'] === 'doctor')): ?>
          <li class="nav-item">
            <a class="nav-link" href="appointments.php">Appointments</a>
          </li>
        <?php endif; ?>
        <!-- it just displays if the user is admin -->
      ...
      <ul class="navbar-nav ml-auto">
        <?php if (isset($_SESSION['username'])): ?>
          ...
          <!-- displays the log in in case no user is logged in -->
        <?php else: ?>
          <li class="nav-item">
